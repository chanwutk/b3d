...
from strongsort.trackers.strong_sort.sort.nn_matching import NearestNeighborDistanceMetric
from strongsort.trackers.strong_sort.sort.detection import Detection
from strongsort.trackers.strong_sort.sort.tracker import Tracker

from strongsort.trackers.strong_sort.reid_multibackend import ReIDDetectMultiBackend
...
class FeatureExtractor:
    ...
    def features(self, bbox_xywh, ori_img):
...
class StrongSORT(object):
    ...
    def update(self, dets, ids: "list", features):
